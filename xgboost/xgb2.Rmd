...
bst_log <- xgb.train(data=dtrain_log, params = param_log, nthread = 7, nround=100, watchlist=watchlist)
```
...
bst_lin <- xgb.train(data=dtrain_lin, params = param_lin, nthread = 7, nround=100, watchlist=watchlist2)
```
